...
export const ActivityEditor: FC<{
  submitHandler: (event: FormEvent<HTMLFormElement>) => Promise<void>;
  isNameAvailable?: (name?: string) => Promise<boolean>;
  activity?: Activity;
}> = ({ submitHandler, isNameAvailable, activity }) => {
  return (
      ...
      <Form.Group as={Row} className="mb-3" controlId="image">
        ...
        <Col column sm={10}>
          <FileUpload
            ...
            multiple
            required
            defaultValue={activity?.banners.map(banner => banner.uri)}
          />
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} className="mb-3" controlId="peopleLimit">
        ...
        <Col column sm={10}>
          <Form.Control
            ...
            type="number"
            placeholder="0 表示无限"
            defaultValue={activity ? activity.maxEnrollment : 0}
          />
        </Col>
      </Form.Group>
