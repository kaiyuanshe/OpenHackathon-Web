      ...
      <>
        <Form
          onSubmit={event => {
            ...
            onSearch?.(formToJSON<{ keyword: string }>(event.currentTarget).keyword);
          }}
        >
          <Form.Group as={Row}>
            <Col>
...
export type UserListProps = Pick<ScrollListProps<User, UserFilter>, 'store'> & UserListLayoutProps;
  ...
  render() {
    ...
    return (
      <ScrollList
        ...
        renderList={allItems => (
          <UserListLayout {...props} defaultData={allItems} onSearch={this.onSearch} />
        )}
      />
    );
  }
