...
export default {
  ...
  edit_questionnaire: 'Questionnaire',
  text: 'text',
  link: 'link',
  question_id: 'Question ID',
  question_id_repeat: 'Question ID cannot be repeated',
  question_description: 'Question Description',
  question_type: 'Question Type',
  option_config: 'Option configuration',
  whether_multiple: 'Multiple choice or not',
  ...
  create_questionnaire_success: 'Questionnaire created successfully!',
  update_questionnaire_success: 'Questionnaire updated successfully!',
  delete_questionnaire: 'Delete questionnaire',
  delete_questionnaire_success: 'Delete questionnaire successfully!',
